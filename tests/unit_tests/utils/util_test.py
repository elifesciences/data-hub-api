...
class TestGetPreviousElementOfGivenElementInGivenList:
    def test_should_return_none_if_given_element_is_first_element_of_the_list(self):
        ...
        assert not get_previous_element_of_given_element_in_given_list(given_list, 'item_1')

    def test_should_return_none_if_given_element_is_not_in_the_list(self):
        given_list = ['item_1', 'item_2']
        assert not get_previous_element_of_given_element_in_given_list(given_list, 'item_3')
